...
DROP TRIGGER TRI_NEW_TABLE_rno;
...
DROP SEQUENCE SEQ_NEW_TABLE_rno;
...
CREATE SEQUENCE SEQ_NEW_TABLE_rno INCREMENT BY 1 START WITH 1;
...
CREATE OR REPLACE TRIGGER TRI_NEW_TABLE_rno BEFORE INSERT ON NEW_TABLE
FOR EACH ROW
BEGIN
	SELECT SEQ_NEW_TABLE_rno.nextval
	INTO :new.rno
	FROM dual;
END;
